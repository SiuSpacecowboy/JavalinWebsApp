package gg.jte.generated.ondemand.start;
import util.NameRoutes;
import dto.UserPage;
public final class JtestartpageGenerated {
	public static final String JTE_NAME = "start/start-page.jte";
	public static final int[] JTE_LINE_INFO = {0,0,1,2,2,2,4,4,8,8,9,9,11,11,11,15,15,16,16,18,18,18,25,25,30,30,31,31,31,31,33,33,33,33,33,33,33,33,33,34,34,34,34,34,34,34,34,34,38,39,40,40,40,40,40,2,2,2,2};
		...
		gg.jte.generated.ondemand.layout.JtepageGenerated.render(jteOutput, jteHtmlInterceptor, null, new gg.jte.html.HtmlContent() {
			public void writeTo(gg.jte.html.HtmlTemplateOutput jteOutput) {
				...
				if (page.getUser() != null) {
					jteOutput.writeContent("\r\n        <div>\r\n        <h1><p style=\"color:rgb(255, 69, 0)\">Welcome to the site, ");
